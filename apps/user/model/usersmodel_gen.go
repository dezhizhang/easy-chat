...
func (m *defaultUsersModel) Insert(ctx context.Context, data *Users) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Id, data.Avatar, data.Username, data.Nickname, data.Phone, data.Password, data.Status, data.Gender)
	}, usersIdKey, usersPhoneKey)
	return ret, err
}
...
func (m *defaultUsersModel) Update(ctx context.Context, newData *Users) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Avatar, newData.Username, newData.Nickname, newData.Phone, newData.Password, newData.Status, newData.Gender, newData.Id)
	}, usersIdKey, usersPhoneKey)
	return err
}
